...
export const stopRecording = initCheck((...args) => instance.assistManager.stopRecording(...args))
export const requestRecording = initCheck((...args) => instance.assistManager.requestRecording(...args))
